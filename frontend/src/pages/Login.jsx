    ...
    return (
        <div className="min-h-screen w-full relative overflow-hidden bg-slate-950 flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-[20%] right-[-10%] w-[35%] h-[45%] rounded-full bg-sky-600/20 blur-[120px] animate-blob" style={{ animationDelay: '2s' }} />
                <div className="absolute bottom-[-20%] left-[20%] w-[50%] h-[50%] rounded-full bg-indigo-600/20 blur-[120px] animate-blob" style={{ animationDelay: '4s' }} />
            </div>
            ...
            >
                <div className="glass rounded-2xl p-8 sm:p-10 space-y-8">
                    <div className="text-center space-y-2">
                        <h1 className="text-3xl font-bold tracking-tight text-slate-50">Welcome Back Student</h1>
